...
export const ImuCharacter: React.FC = () => {
  ...
  return (
    ...
    >
      {showMessage && (
        <div className="absolute -top-12 left-1/2 -translate-x-1/2 bg-white text-gray-800 text-xs font-bold py-2 px-3 rounded-xl shadow-lg border border-gray-200 whitespace-nowrap animate-bounce">
          ¡¡¡Joyboy!!!
