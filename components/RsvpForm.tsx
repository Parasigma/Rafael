...
export const RsvpForm: React.FC<RsvpFormProps> = ({ onSubmit }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    try {
      ...
      // 1. Creamos un formulario real en código
      const form = document.createElement('form');
      form.action = 'https://formsubmit.co/parasigmita@gmail.com';
      form.method = 'POST';
      // ¡LA CLAVE ESTÁ AQUÍ! Lo mandamos a una pestaña nueva para poder ver qué hace FormSubmit
      form.target = '_blank'; 
      ...
      // 2. Metemos todos los datos (he quitado la anulación de Captcha para no enfadar al servidor)
      ...
      // 3. Disparamos el formulario (esto abrirá la pestaña nueva)
      document.body.appendChild(form);
      form.submit();
      document.body.removeChild(form);

      // 4. Actualizamos nuestra web actual
      ...
      alert("Ocurrió un error en el navegador al crear el formulario.");
      setIsSubmitting(false);
    }
  };
